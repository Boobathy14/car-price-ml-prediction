...
def predict():
    ...
    if request.method =='POST':
        ...
        if output < 0:
            return render_template('home.html',prediction_texts="Sorry you can't sell your car")
        else:
            return render_template('home.html',prediction_text="Your Car can Priced at {} Lakhs".format(output))
    else:
        return render_template('home.html')
